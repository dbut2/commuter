...
type ClientService interface {
	...
	GetRouteAsGPXContext(ctx context.Context, params *GetRouteAsGPXParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRouteAsGPXOK, error)
	...
	GetRouteAsTCXContext(ctx context.Context, params *GetRouteAsTCXParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRouteAsTCXOK, error)
...
func (a *Client) GetRouteAsGPX(params *GetRouteAsGPXParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRouteAsGPXOK, error) {
	...
	return a.GetRouteAsGPXContext(ctx, params, authInfo, opts...)
}
...
*/
func (a *Client) GetRouteAsGPXContext(ctx context.Context, params *GetRouteAsGPXParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRouteAsGPXOK, error) {
...
func (a *Client) GetRouteAsTCX(params *GetRouteAsTCXParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRouteAsTCXOK, error) {
	...
	return a.GetRouteAsTCXContext(ctx, params, authInfo, opts...)
}
...
*/
func (a *Client) GetRouteAsTCXContext(ctx context.Context, params *GetRouteAsTCXParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRouteAsTCXOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
